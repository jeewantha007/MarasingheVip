      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group rounded-lg overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl hover:border-primary/30 transition-all duration-300">
            ...
            <div className="p-6">
              <h3 className="font-bodoni text-2xl font-bold mb-2">Ocean Breeze</h3>
          ...
          <div className="group rounded-lg overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl hover:border-primary/30 transition-all duration-300">
            ...
            <div className="p-6">
              <h3 className="font-bodoni text-2xl font-bold mb-2">Nature Bliss</h3>
          ...
          <div className="group rounded-lg overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl hover:border-primary/30 transition-all duration-300">
            ...
            <div className="p-6">
              <h3 className="font-bodoni text-2xl font-bold mb-2">Royal Rose</h3>
