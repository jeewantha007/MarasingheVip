        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="w-24 h-24 bg-primary/10 rounded-full flex items-center justify-center mb-8">
              <span className="font-playfair text-3xl text-primary font-bold">M</span>
            </div>
            <h2 className="font-playfair text-4xl md:text-5xl font-bold text-text-dark mb-6">Our Story</h2>
            ...
            <div className="pt-6 border-t border-gray-200">
              <h4 className="font-playfair text-xl font-bold mb-4">Our Promise</h4>
